package com.educhandan.educhandan.classes;
...
import com.educhandan.educhandan.NotesDisplayActivity;
import com.educhandan.educhandan.R;
import com.educhandan.educhandan.TestSetsActivity;
...
public class MyCoursesAdapter extends RecyclerView.Adapter<MyCoursesAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setData(final String titleName, String descName, String imageLink, final String productId) {
            ...
            Glide.with(itemView.getContext()).load(imageLink).transition(GenericTransitionOptions.with(R.anim.fade_in)).apply(new RequestOptions().placeholder(R.drawable.pdffile)).into(courseImage);
                    ...
                    itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            try {
                                ...
                                Toast.makeText(v.getContext(), "Sorry Download Could Not Be Started! Please contact Educhandan Team!", Toast.LENGTH_LONG).show();
                            } catch (Throwable e){
                                Toast.makeText(v.getContext(), "Sorry Download Could Not Be Started! Please contact Educhandan Team!", Toast.LENGTH_LONG).show();
                            }
