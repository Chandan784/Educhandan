...
import com.educhandan.educhandan.LecturePlayActivity;
import com.educhandan.educhandan.NotesDisplayActivity;
import com.educhandan.educhandan.QuestionDisplayActivity;
import com.educhandan.educhandan.R;
import com.educhandan.educhandan.TestAnalysisActivity;
import com.educhandan.educhandan.TestInstructionActivity;
        ...
        private void setData(final String title, int type, final String idOrUrl) {
            ...
            if (!title.equals("")) {
                ...
                if (type == CourseSubjectsActivity.LECTURE) {
                    ...
                    icon.setImageResource(R.drawable.pdffile);
