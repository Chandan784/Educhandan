...
import com.educhandan.educhandan.classes.TestsMetaModel;
...
public class TestInstructionActivity extends AppCompatActivity {
    ...
    public void loadTestMeta(){
        ...
        try {
            ...
            reference.child("QuestionsData").child(prodId).child("set" + setNo).child("maxTime").addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
