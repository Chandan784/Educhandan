...
import com.educhandan.educhandan.classes.TestSetsAdapter;

import java.util.ArrayList;
import java.util.List;

import static com.educhandan.educhandan.classes.DBqueries.setTitleList;
...
public class TestSetsActivity extends AppCompatActivity {
    ...
    private FirebaseDatabase database = FirebaseDatabase.getInstance("https://educhandan-bb0b4-default-rtdb.firebaseio.com/");
    ...
    public void setRecyclerView(){
        ...
        if (numberOfSets != null){
            ...
            Toast.makeText(this, "There are currently no sets in this test! Please contact Educhandan Team.", Toast.LENGTH_SHORT).show();
        }
